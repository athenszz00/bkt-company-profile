...
import binagunaLogo from './assets/clients/binaguna.png';
import bptangguhLogo from './assets/clients/bptangguh.png';
import controlsystemsLogo from './assets/clients/controlsystems.png';
import donggisenoroLogo from './assets/clients/donggisenoro.png';
import endresshauserLogo from './assets/clients/endresshauser.png';
import gktLogo from './assets/clients/gkt.jpg';
import gunaeramanufakturaLogo from './assets/clients/gunaeramanufaktura.jpg';
import imecointersaranaLogo from './assets/clients/imecointersarana.jpg';
import indokomasLogo from './assets/clients/indokomas.png';
import ipmomipaitonLogo from './assets/clients/ipmomipaiton.png';
import ismayaLogo from './assets/clients/ismaya.jpg';
import istanakaranglautLogo from './assets/clients/istanakaranglaut.jpg';
...
const sppbePartners = [
  'SPPBE PT. WIRABANGUN, BANDUNG',
  'SPPBE PT. BAJUBANG GASINDO / SADIKUN GROUP, BANDUNG',
  'SPPBE PT. PURNATARUM, BANDUNG',
  'SPPBE PT. RADEKATAMA MITRA, BANDUNG',
  'SPPBE PT. INDONESIA BINTANG CEMERLANG, BANDUNG',
  'SPPBE PT. API BIRU NUSANTARA, BANDUNG',
  'SPPBE PT. JABAR ENERGY, BANDUNG',
  'SPPBE PT. SADIKUN LPG 3KG, BANDUNG',
  'SPPBE PT. ERAWAN, BANTEN',
  'SPPBE PT. GIGAINTRAX, BANYUMAS',
  'SPPBE PT. BUMINDO, BEKASI',
  'SPPBE PT. INTIM WIRA ENERGI, BEKASI',
  'SPPBE PT. CHUNUR, CIANJUR',
  'SPPBE PT. WINGAS, CIKANDE',
  'SPPBE PT. ENERGI BIRU PERKASA, CIREBON',
  'SPPBE PT. ASGARAYA, GARUT',
  'SPPBE PT. SINAR MUTIARA INDAH, JAKARTA',
  'SPPBE PT. SADIKUN, JAKARTA',
  'SPPBE PT. GAS ABADI SUKSES, JAYAPURA',
  'SPPBE PT. GAS BUMI NUSANTARA JAYA, JOMBANG',
  'SPPBE PT. OM AGUS, LOMBOK',
  'SPPBE PT. BINTANG ENERGI ABADI, LOMBOK',
  'SPPBE PT. DELTA ADIGUNA, LOMBOK',
  'SPPBE PT. LIMA GAS JAYA MANDIRI, MAKASSAR',
  'SPPBE PT. PERMATA ALAM SULAWESI, MAKASSAR',
  'SPPBE PT. GASKIMA PRIMA KENCANA, MAKASSAR',
  'SPPBE PT. YUDHAGUNA SARITIRTA, MAKASSAR',
  'SPPBE PT. RAMA MANGGALA, MALANG',
  'SPPBE PT. MULIA JAYA, MANADO',
  'SPPBE PT. KARYA MUSI MANDIRI, PALEMBANG',
  'SPPBE PT. KARYA MUSIM MANDIRI, PALEMBANG',
  'SPPBE PT. DHARMA KUMALA KENCANA, PURWAKARTA',
  'SPPBE PT. GASINDO GRAHA UTAMA, PURWOKERTO',
  'SPPBE PT. NANGGALA, SEMARANG',
  'SPPBE PT. CAHAYA GAS GEMILANG, SUBANG',
  'SPPBE PT. SPECTRA ENERGI, SUKABUMI',
  'SPPBE PT. ATHENA, TANGERANG',
  'SPPBE PT. ARTHA JAYA GAS, TANGERANG',
  'SPPBE PT. PERNADI WIRAPERKASA, TANGERANG',
  'SPPBE PT. PERNADI, TANGERANG',
  'SPPBE PT. PENTA ENERGI, TANGERANG',
  'SPPBE PT. PATRA TRADING DEPO PERTAMINA, TJ. PRIOK JAKARTA',
  'SPPBE PT. SINAR WAHANA SURYA, TULUNG AGUNG',
];
